...
np.save('/scratch/prunet/polyFT/approx/fmask_n%d_m%d'%(n_petals,m),diff.polygonal_fmask)
# Save diffraction patterns
print('Saving diffraction patterns')
#np.save('/data101/prunet/diffraction_n%d_m%d'%(n,m),diff.diffracted)
np.save('/scratch/prunet/polyFT/approx/diffraction_n%d_m%d'%(n_petals,m),diff.diffracted)
