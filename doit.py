...
n_border = 2000
n_petals = 24
print('Creating petal with %d points'%(n_petals*2*24))
...
np.save('/scratch/prunet/polyFT/trapeze/fmask_n%d_m%d'%(n_petals,m),diff.polygonal_fmask)
# Save diffraction patterns
print('Saving diffraction patterns')
#np.save('/data101/prunet/diffraction_n%d_m%d'%(n,m),diff.diffracted)
np.save('/scratch/prunet/polyFT/trapeze/diffraction_n%d_m%d'%(n_petals,m),diff.diffracted)
